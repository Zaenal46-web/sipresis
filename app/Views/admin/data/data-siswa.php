   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12 col-md-12">
            ...
            <?php endif; ?>
            <a class="btn btn-secondary font-weight-bold border border-dark ml-3 pl-3 py-3" href="<?= base_url('admin/siswa/create'); ?>">
               <i class="material-icons mr-2">add</i> Tambah data siswa
            </a>
            <a class="btn btn-secondary font-weight-bold border border-dark ml-3 pl-3 py-3" href="<?= base_url('admin/siswa/bulk'); ?>">
            ...
            <div class="card">
               <div class="card-header card-header-tabs card-header-success" style="background: #141C6E !important;">
                  <div class="nav-tabs-navigation">
                     <div class="row">
                        <div class="col-md-2">
                           <h4 class="card-title-dark"><b>Daftar Siswa</b></h4>
