    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="card">
                    <div class="card-header card-header-primary" style="background: #141C6E !important;">
                    ...
                    <div class="card-body mx-5 my-3">
                        ...
                        <form action="<?= base_url('admin/general-settings/update'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="display-block">
                                            <button type="button" onclick="$('#logo-upload').trigger('click');" class="btn btn-primary btn-sm btn-file-upload" style="background: #1E2998 !important;">
                                                Ganti
                                            </button>
                            ...
                            <button type="submit" class="btn btn-primary btn-block" style="background: #1E2998 !important;">Simpan</button>
                        </form>
