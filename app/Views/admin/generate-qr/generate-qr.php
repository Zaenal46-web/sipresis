                  ...
                  <div class="card-body">
                    ...
                    <div class="row px-2">
                      <div class="col-12 col-xl-6 px-1">
                        <button onclick="generateAllQrSiswa()" class="btn btn-success p-2 px-md-4 w-100" style="background: #1E2998 !important;">
                      ...
                      <div class="col-12 col-xl-6 px-1">
                        <a href="<?= base_url('admin/qr/siswa/download'); ?>" class="btn btn-success p-2 px-md-4 w-100" style="background: #1E2998 !important;">
                          <div class="d-flex align-items-center justify-content-center" style="gap: 12px;">
                            <div>
                    ...
                    <hr>
                    <br>
                    <h4 class="text-dark"><b>Generate per kelas</b></h4>
                    <form action="<?= base_url('admin/qr/siswa/download'); ?>" method="get">
                      ...
                      <div class="row px-2">
                        <div class="col-12 col-xl-6 px-1">
                          <button type="button" onclick="generateQrSiswaByKelas()" class="btn btn-primary p-2 px-md-4 w-100" style="background: #1E2998 !important;">
                            <div class="d-flex align-items-center justify-content-center" style="gap: 12px;">
                              <div>
                                <i class="material-icons" style="font-size: 24px;">qr_code</i>
                              </div>
                        ...
                        <div class="col-12 col-xl-6 px-1">
                          <button type="submit" class="btn btn-primary p-2 px-md-4 w-100" style="background: #1E2998 !important;">
                            <div class="d-flex align-items-center justify-content-center" style="gap: 12px;">
                              <div>
                                <i class="material-icons" style="font-size: 24px;">cloud_download</i>
                              </div>
