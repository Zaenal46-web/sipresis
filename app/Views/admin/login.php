 ...
 <a href="<?= base_url('/'); ?>" class="btn btn-primary pull-right pl-3" style="background: #1E2998 !important;" >
       ...
       <div class="container-fluid">
          <div class="row">
             <div class="col-md-4 m-auto">
                <div class="card">
                   <div class="card-header card-header-primary mb-48" style="background: #141C6E !important;">
                      <h4 class="card-title">Sistem Presensi Siswa SMAN 1 Kandangan</h4>
                   ...
                   <div class="card-body mx-5 my-3">
                      ...
                      <form action="<?= url_to('login') ?>" method="post">
                         ...
                         <button type="submit" class="btn btn-primary btn-block" style="background: #1E2998 !important;"><?= lang('Auth.loginAction') ?></button>
