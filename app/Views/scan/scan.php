 ...
 <a href="<?= base_url('/admin'); ?> " class="btn btn-primary pull-right pl-3" style="background: #1E2998 !important;">
       ...
       <div class="container-fluid">
          <div class="row mx-auto">
             ...
             <div class="col-lg-6 col-xl-4">
                <div class="card">
                   <div class="col-10 mx-auto card-header card-header-primary" style="background: #1E2998 !important;">
                      <div class="row">
                         <div class="col">
